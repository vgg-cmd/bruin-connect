...
function getRecommendations({ identity, location, interests, career, gradYear }) {
  ...
  const IN = {
    black: { name: "Black Alumni Association", url: "https://alumni.ucla.edu/diversity-programs-and-initiatives/networks/", desc: "Events, networking, and cultural celebrations with the BAA community.", tag: "diversity network", icon: "✊🏿" },
    latino: { name: "Latino Alumni Association", url: "https://alumni.ucla.edu/diversity-programs-and-initiatives/networks/", desc: "Community events, EmPower Hour book talks, and cultural programming.", tag: "diversity network", icon: "🌎" },
    asian_pacific: { name: "Asian Pacific Alumni", url: "https://alumni.ucla.edu/diversity-programs-and-initiatives/networks/", desc: "Networking and cultural events for Asian and Pacific Islander Bruins.", tag: "diversity network", icon: "🌏" },
    ...
    american_indian: { name: "American Indian Alumni", url: "https://alumni.ucla.edu/diversity-programs-and-initiatives/networks/", desc: "Cultural events and community programming for Indigenous Bruins.", tag: "diversity network", icon: "🪶" },
    ...
    lgbtq: { name: "Lambda Alumni Association", url: "https://alumni.ucla.edu/diversity-programs-and-initiatives/networks/", desc: "Social events, pride celebrations, and community building for LGBTQ+ Bruins.", tag: "diversity network", icon: "🏳️‍🌈" },
    ...
    first_gen: { name: "First Gen Alumni Network", url: "https://alumni.ucla.edu/alumni-networks/affinity-networks/", desc: "Mentorship, resources, and community for first-generation grads.", tag: "affinity network", icon: "⭐" },
    ...
    veteran: { name: "VetNet", url: "https://alumni.ucla.edu/alumni-networks/affinity-networks/", desc: "Career resources, community events, and networking for Bruin veterans.", tag: "affinity network", icon: "🎖️" },
    disability: { name: "Disability Alumni Network", url: "https://alumni.ucla.edu/alumni-networks/affinity-networks/", desc: "Advocacy and connection for Bruins in the disability community.", tag: "affinity network", icon: "♿" },
  ...
  const LN = {
    la_westside: { name: "LA Westside Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    la_downtown: { name: "LA Downtown Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    la_southeast: { name: "LA Southeast Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    san_fernando: { name: "San Fernando Valley Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    south_bay: { name: "South Bay Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    ...
    orange_county: { name: "Orange County Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    ...
    bay_area: { name: "Bay Area Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    ...
    arizona: { name: "Arizona Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    ny_tristate: { name: "New York Tri-State Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    dc: { name: "Washington D.C. Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
    chicago: { name: "Chicago Network", url: "https://alumni.ucla.edu/alumni-networks/regional-networks/" },
