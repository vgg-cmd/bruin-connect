...
function getRecommendations({ identity, location, interests, career, gradYear }) {
  ...
  if (interests.includes("entertainment")) recs.push({ name: "Bruin Entertainment Network", url: "https://alumni.ucla.edu/events-calendar/category/bruin-entertainment-network", desc: "The network for Bruins in film, TV, music, gaming, and media.", tag: "industry", icon: "🎬" });
  ...
  if (career === "job_searching" || career === "early_career") {
    ...
    recs.push({ name: "Bruin Professionals Network", url: "https://alumni.ucla.edu/events-calendar/category/bruin-professionals", desc: "Professional networking events, panels, and workshops.", tag: "career", icon: "🤝" });
  }
            ...
            <BotMessage text={<><strong>your personalized bruin toolkit, {name}.</strong><br />We matched you with <strong>{results.length} networks and resources</strong> based on your selections. Tap any card to explore.</>} animate>
              ...
              <div style={{ marginTop: 20, padding: "14px 18px", background: COLORS.lightestBlue, borderRadius: 8, borderLeft: `4px solid ${COLORS.uclaGold}` }}>
                <div style={{ fontSize: 13, color: COLORS.black, lineHeight: 1.7, fontFamily: "'Inter', sans-serif" }}>
                  ...
                  <a href="https://alumni.ucla.edu/alumni-networks/" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.uclaBlue, textDecoration: "underline" }}>All Networks</a>{" · "}
                  ...
                  <a href="https://alumni.ucla.edu/diversity-programs-and-initiatives/" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.uclaBlue, textDecoration: "underline" }}>Diversity Programs</a>{" · "}
